# Chang directory to the folder of this file
import os
import pathlib
...
from Module.Hand_Tracking_Module_cvzone_custom import HandDetector
import cv2
...
model = load_model('Module/MobileNet_with_new_data.h5')
